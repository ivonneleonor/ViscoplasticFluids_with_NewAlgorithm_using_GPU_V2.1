...
!have to have deltaX * MaxI = 1.0
	real*8, parameter::  deltaX = 0.03125d0!stepsize in phi - direction
	integer, parameter:: MaxI = 30 !no of steps in the phi - direction
...
! all of these are fixed for your flow loop
	real*8, parameter:: deltaY = 0.0390625d0 !stepsize in z- direction
	integer, parameter:: MaxJ = 254  !no of steps in z- direction
