...
!have to have deltaX * MaxI = 1.0
	real*8, parameter::  deltaX = 0.0714285d0 !stepsize in phi - direction
	integer, parameter:: MaxI = 14 !no of steps in the phi - direction
...
! all of these are fixed for your flow loop
	real*8, parameter:: deltaY = 0.652933d0 !stepsize in z- direction
	integer, parameter:: MaxJ = 30 !no of steps in z- direction
