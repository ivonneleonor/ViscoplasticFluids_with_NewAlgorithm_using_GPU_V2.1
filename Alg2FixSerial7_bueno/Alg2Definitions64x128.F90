...
!have to have deltaX * MaxI = 1.0
	real*8, parameter::  deltaX = 0.016129d0 !stepsize in phi - direction
	integer, parameter:: MaxI = 62 !no of steps in the phi - direction
...
! all of these are fixed for your flow loop
	real*8, parameter:: deltaY = 0.15546d0 !stepsize in z- direction
	integer, parameter:: MaxJ = 126 !no of steps in z- direction
