...
!have to have deltaX * MaxI = 1.0
	real*8, parameter::  deltaX = 0.071428d0 !stepsize in phi - direction
...
! all of these are fixed for your flow loop
	real*8, parameter:: deltaY = 1.39d0 !stepsize in z- direction
	integer, parameter:: MaxJ = 14 !no of steps in z- direction
